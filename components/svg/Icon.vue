<template>
  <div>
    <!-- overview -->
    <svg v-if="icon === 'overview'" id="icon-overview" viewBox="0 0 21 22">
      <path
    ...
    >
      ...
      <path
        ...
        stroke-width="1"
        stroke="#2249B3"
        d="M12 22V12H22C22 17.52 17.52 22 12 22Z"
        fill="#8FE4FF"
      ></path>
      <path
        stroke-linecap="round"
